...
/********************************************************************
* @Class Name         : VendorSAPEntity.java                                                                
*                                                                                                                                        
...
public class VendorSAPEntity
{
	...
	private String fax;
	private String alt_first_name;
	private String alt_last_name;
	...
	public String getVendor_sap_code() {
		return vendor_sap_code;
	}

	public void setVendor_sap_code(String vendor_sap_code) {
	...
	public String getAlt_first_name()
	{
		return alt_first_name;
	}

	public void setAlt_first_name(String alt_first_name)
	{
		this.alt_first_name = alt_first_name;
	}

	public String getAlt_last_name()
	{
		return alt_last_name;
	}

	public void setAlt_last_name(String alt_last_name)
	{
		this.alt_last_name = alt_last_name;
	}
	...
	{
		this.alt_email_id = alt_email_id;
	}
